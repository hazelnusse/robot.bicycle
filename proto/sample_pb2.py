...
_INVENSENSEMPU6050 = descriptor.Descriptor(
...
_ENCODER = descriptor.Descriptor(
  name='Encoder',
  full_name='Encoder',
  filename=None,
  file=DESCRIPTOR,
...
_MOTORCURRENT = descriptor.Descriptor(
  name='MotorCurrent',
...
_SETPOINT = descriptor.Descriptor(
  name='SetPoint',
  full_name='SetPoint',
  filename=None,
  file=DESCRIPTOR,
...
_ESTIMATOR = descriptor.Descriptor(
  name='Estimator',
  full_name='Estimator',
  filename=None,
  file=DESCRIPTOR,
...
_PICONTROLLER = descriptor.Descriptor(
  name='PIController',
